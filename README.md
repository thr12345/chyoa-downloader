...
```bash
chyoa-downloader "https://chyoa.com/chapter/your-story-url" -c "laravel_session=your_session_cookie"
```
...
```bash
chyoa-downloader "https://chyoa.com/chapter/your-story-url" --no-puppeteer
```
...
**Session Location:**
Sessions are stored in `~/.config/chyoa-downloader/session.json`
...
chyoa-downloader "https://chyoa.com/chapter/example.123456"

# Download with manual session cookie
chyoa-downloader "https://chyoa.com/chapter/example.123456" -c "laravel_session=abc123"

# Download to custom base directory
chyoa-downloader "https://chyoa.com/chapter/example.123456" -o "my_stories"

# Save all chapters to a single file
chyoa-downloader "https://chyoa.com/chapter/example.123456" --single-file

# Embed images as base64 in markdown (no separate image files)
chyoa-downloader "https://chyoa.com/chapter/example.123456" --embed-images

# Keep original image formats (disable WebP conversion)
chyoa-downloader "https://chyoa.com/chapter/example.123456" --no-webp

# Combine options: single file with embedded images
chyoa-downloader "https://chyoa.com/chapter/example.123456" --single-file --embed-images

# Clear saved session before downloading
chyoa-downloader "https://chyoa.com/chapter/example.123456" --clear-session

# Use direct HTTP requests (may be blocked by Cloudflare)
chyoa-downloader "https://chyoa.com/chapter/example.123456" --no-puppeteer

# Test connectivity without downloading
chyoa-downloader --test
